...
$file = "$env:USERPROFILE\AppData\Local\NINA\Plugins\InstructionMath\InstructionMath.dll";
$createArchive = 1;
$includeAll = 1;
...
if($createArchive) {
    ...
    $zipfile = ($archiveName -replace '\s','_') + "-" + $version[0] + "." + $version[1] + "." + $version[2]  + ".zip"
...
$installerUrl = "https://github.com/FlyingKiwis/Nina.InstructionMath/releases/download/v" + $version[0] + "." + $version[1] + "." + $version[2] + "/" + $archiveName;
